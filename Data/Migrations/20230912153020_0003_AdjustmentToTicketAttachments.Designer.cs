...
namespace Chrysalis.Data.Migrations
{
    ...
    [Migration("20230912153020_0003_AdjustmentToTicketAttachments")]
    partial class _0003_AdjustmentToTicketAttachments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chrysalis.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BTUserProject", b =>
                {
                    b.HasOne("Chrysalis.Models.BTUser", null)
                        .WithMany()
                        .HasForeignKey("MembersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chrysalis.Models.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Chrysalis.Models.BTUser", b =>
                {
                    b.HasOne("Chrysalis.Models.Company", "Company")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Chrysalis.Models.Invite", b =>
                {
                    ...
                    b.HasOne("Chrysalis.Models.BTUser", "Invitee")
                        .WithMany()
                        .HasForeignKey("InviteeId");

                    b.HasOne("Chrysalis.Models.BTUser", "Invitor")
                        .WithMany()
                        .HasForeignKey("InvitorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chrysalis.Models.Project", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("Chrysalis.Models.Notification", b =>
                {
                    b.HasOne("Chrysalis.Models.NotificationType", "NotificationType")
                        .WithMany()
                    ...
                    b.HasOne("Chrysalis.Models.BTUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chrysalis.Models.BTUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Chrysalis.Models.Project", b =>
                {
                    ...
                    b.HasOne("Chrysalis.Models.ProjectPriority", "ProjectPriority")
                        .WithMany()
            ...
            modelBuilder.Entity("Chrysalis.Models.Ticket", b =>
                {
                    b.HasOne("Chrysalis.Models.BTUser", "DeveloperUser")
                        .WithMany()
                    ...
                    b.HasOne("Chrysalis.Models.BTUser", "SubmitterUser")
                        .WithMany()
                        .HasForeignKey("SubmitterUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chrysalis.Models.TicketPriority", "TicketPriority")
                        .WithMany()
                        .HasForeignKey("TicketPriorityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chrysalis.Models.TicketStatus", "TicketStatus")
                        .WithMany()
                        .HasForeignKey("TicketStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chrysalis.Models.TicketType", "TicketType")
                        .WithMany()
